...
export default class BuyProduct extends Component
{
    ...
    {      
        axios.post(`${SERVER_HOST}/sales/${paymentData.orderID}/${this.props.productID}/${this.props.price}/${localStorage.name}/${localStorage.email}`, {headers:{"authorization":localStorage.token, "Content-type": "multipart/form-data"}})
        .then(res => 
        {                   
